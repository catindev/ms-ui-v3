(function() {
    ...
    function template({ _id, name, trunk, phones, account: { noTargetReasons } }) {
        ...
        <div class="sidebar onlyDesktop">
            <a class="sidebar__link" href="/leads/hot/${ _id }">Профиль 🗿</a>
            <div class="sidebar__divider"></div>
            <a class="sidebar__link" href="/leads/hot/${ _id }/edit">
                Заполнить профиль 📝
            </a>
            <a class="sidebar__link sidebar__link--active" href="/leads/hot/${ _id }/reject">
                Оформить отказ 🚯
            </a>
        </div> 
